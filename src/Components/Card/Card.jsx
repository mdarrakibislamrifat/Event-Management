...
const Card = ({card}) => {
  ...
  <div className="p-6">
    ...
    <h4 style={{color:text_color,backgroundColor:bg_color}} className="mb-2 block font-sans text-2xl font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased w-[150px] text-center rounded-md lg:w-[200px] p-3">
      {event_name}
    </h4>
